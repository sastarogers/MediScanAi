...
import { Camera, Send, X, ArrowLeft, Image as ImageIcon, Eye, Sparkles, Mic, MicOff } from 'lucide-react';
import { Button, Card, Badge, Skeleton, PageTransition } from '../components/Shared';
import { analyzeSymptoms, fileToBase64 } from '../services/geminiService';
import { AnalysisResponse, HealthRecord, Message, TriageLevel, UserProfile } from '../types';
      ...
      <div className="flex-1 overflow-y-auto space-y-6 px-2 pb-6 scroll-smooth">
        ...
        {analysis && analysis.status === 'complete' && (
          <div className="animate-slide-up duration-500 space-y-4 pt-2">
            ...
            <Button onClick={() => { setAnalysis(null); setMessages([]); }} variant="outline" className="w-full py-4 text-base">
              {t('scan_new', language)}
            </Button>
          </div>
        )}
